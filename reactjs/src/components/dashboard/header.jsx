    ...
    return (
        <React.Fragment>
            <header className="bg-white">
                        ...
                        <div className="flex justify-between">
                            ...
                            <div className="flex space-x-4">
                                <a href="/" className="flex items-center py-5 px-2 text-gray-700 hover:text-gray-900">
                                    ...
                                    <span className="font-bold">CMS Dashboard</span>
                                </a>
                            </div>
                            ...
                            <ul className="hidden md:flex items-center space-x-1">
                                ...
                                <li className="py-5 px-3 text-gray-700 hover:text-gray-900">
                                    <button className="menu-button p-2 bg-white rounded-lg shadow-lg">
                ...
                <div className="md:hidden sidebar-admin fixed right-0 top-0 h-full w-64 bg-white shadow-lg transform -translate-x-full md:translate-x-0 transition-transform duration-300 z-40">
                    <div className="p-4">
                        {/* Logo */}
                        <div className="mb-8">
                            <a href="/" className="flex items-center text-blue-600">
