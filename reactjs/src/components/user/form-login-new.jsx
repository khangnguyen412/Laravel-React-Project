    ...
    return (
        <React.Fragment>
            ...
            <div className="login-page">
                <LoginFormPage backgroundImageUrl="" logo="" backgroundVideoUrl="" title="Welcome to CMS System" containerStyle={{ backgroundColor: 'rgba(0, 0, 0,0.65)', backdropFilter: 'blur(4px)', }} subTitle="Sign In / Sign Up"
